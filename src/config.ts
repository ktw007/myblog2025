...
export const siteConfig: SiteConfig = {
  ...
  description: "欢迎来到 ktws007 的个人博客",
  // [CONFIG:SITE_AUTHOR]
  author: "ktws007",
  ...
  deployment: {
    ...
    platform: "vercel", // "netlify" | "vercel" | "github-pages" - sets redirect configuration for the chosen platform (use "vercel" for Cloudflare Pages)
  },
  ...
  navigation: {
    ...
    pages: [
      ...
      { title: "小红书", url: "https://xhslink.com/m/6Geph6VJ5Ix" },
    ],
    // [CONFIG:NAVIGATION_SOCIAL]
    social: [
      {
        title: "小红书",
        url: "https://xhslink.com/m/6Geph6VJ5Ix",
        icon: "book-open",
      },
      {
        title: "微信",
